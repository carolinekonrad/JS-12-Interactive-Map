    ...
    function getPreferredSchema(content) {
        ...
        for (var i = 0; i < contentTypes.length; i++) {
            if (isJSON(contentTypes[i])) {
                return (0, openapi_to_json_schema_1["default"])((0, clone_object_1["default"])(content[contentTypes[i]].schema), { refLogger: refLogger });
            }
        }
        ...
        return (0, openapi_to_json_schema_1["default"])((0, clone_object_1["default"])(content[contentType].schema), { refLogger: refLogger });
    }
